...
1. Go to the [Releases](../../releases) page and download `Quitty.dmg`.
2. Open the `.dmg` file.
3. Drag **Quitty.app** into the **Applications** folder.
4. Launch Quitty from Launchpad or your Applications folder.
